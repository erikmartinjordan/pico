...
function createAutoZoomStream(sourceStream, region) {
  ...
  canvas.width = Math.max(2, region.pixelWidth || Math.round(region.width * (region.scaleFactor || 1)));
  canvas.height = Math.max(2, region.pixelHeight || Math.round(region.height * (region.scaleFactor || 1)));
